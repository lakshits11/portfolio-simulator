  ...
  describe('multi-fund scenarios', () => {
    it('uses custom fund allocations correctly and produces expected transactions', () => {
      ...
      const expectedTransactions: Transaction[] = [
        // Fund 0 buys
        { fundIdx: 0, nav: 100, when: new Date('2023-01-01'), units: 0.7, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 105, when: new Date('2023-02-01'), units: 0.667, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 110, when: new Date('2023-03-01'), units: 0.636, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 115, when: new Date('2023-04-01'), units: 0.609, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 120, when: new Date('2023-05-01'), units: 0.583, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 125, when: new Date('2023-06-01'), units: 0.56, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 130, when: new Date('2023-07-01'), units: 0.538, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 135, when: new Date('2023-08-01'), units: 0.519, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 140, when: new Date('2023-09-01'), units: 0.5, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 145, when: new Date('2023-10-01'), units: 0.483, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 150, when: new Date('2023-11-01'), units: 0.467, amount: 70, type: 'buy' },
        { fundIdx: 0, nav: 155, when: new Date('2023-12-01'), units: 0.452, amount: 70, type: 'buy' },
        // Fund 0 sell
        { fundIdx: 0, nav: 160, when: new Date('2024-01-01'), units: 6.713, amount: 1074.092, type: 'sell' },
        // Fund 1 buys
        { fundIdx: 1, nav: 200, when: new Date('2023-01-01'), units: 0.15, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 205, when: new Date('2023-02-01'), units: 0.146, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 210, when: new Date('2023-03-01'), units: 0.143, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 215, when: new Date('2023-04-01'), units: 0.14, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 220, when: new Date('2023-05-01'), units: 0.136, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 225, when: new Date('2023-06-01'), units: 0.133, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 230, when: new Date('2023-07-01'), units: 0.13, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 235, when: new Date('2023-08-01'), units: 0.128, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 240, when: new Date('2023-09-01'), units: 0.125, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 245, when: new Date('2023-10-01'), units: 0.122, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 250, when: new Date('2023-11-01'), units: 0.12, amount: 30, type: 'buy' },
        { fundIdx: 1, nav: 255, when: new Date('2023-12-01'), units: 0.118, amount: 30, type: 'buy' },
        // Fund 1 sell
